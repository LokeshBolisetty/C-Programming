...
int main()
{
    ...
    while (total_number_of_queries--) {
        ...
        if (type_of_query == 1) {
            ...
            if(total_number_of_pages[x]==1)total_number_of_pages= malloc(sizeof(int));
            else
            total_number_of_pages[x] = realloc(total_number_of_pages[x], total_number_of_books[x]*sizeof(int));
            total_number_of_pages[x][total_number_of_books[x]-1]=y;

            //*(*(total_number_of_pages+x)+*total_number_of_books)=y;
            //*(total_number_of_books+x)=*(total_number_of_books)+1;
